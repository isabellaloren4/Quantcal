...
class QCal_knn_3(AggregationMixin, BaseQuantifier):
    '''
...
class QCal_knn_5(AggregationMixin, BaseQuantifier):
    '''
    Quantifier calibration method.
    - KNeighborsRegressor for correction
    - Random Forest classifier for the quantifier
...
class QCal_knn_10(AggregationMixin, BaseQuantifier):
    '''
    Quantifier calibration method.
    - KNeighborsRegressor for correction
    - Random Forest classifier for the quantifier
...
class QCal_knn_3_upp(AggregationMixin, BaseQuantifier):
    '''
    Quantifier calibration method.
    - KNeighborsRegressor for correction
    - Random Forest classifier for the quantifier
