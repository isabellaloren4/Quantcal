...
class QCal_lr_3(AggregationMixin, BaseQuantifier):
    '''
...
class QCal_lr_5(AggregationMixin, BaseQuantifier):
    '''
    Quantifier calibration method.
    - LinearRegression for correction
    - Random Forest classifier for the quantifier
...
class QCal_lr_10(AggregationMixin, BaseQuantifier):
    '''
    Quantifier calibration method.
    - LinearRegression for correction
    - Random Forest classifier for the quantifier
...
class QCal_lr_3_upp(AggregationMixin, BaseQuantifier):
    '''
    Quantifier calibration method.
    - LinearRegression for correction
    - Random Forest classifier for the quantifier
